    ...
    return (
        <div className="bg-[#f9fafb] min-h-screen py-6 sm:py-8 lg:py-10 overflow-x-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                {/* ACTION BUTTONS */}
                <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:justify-end gap-3">
                    ...
                    <button className="text-gray-400 text-sm hover:text-black transition text-center sm:text-right">
                        Cancel Changes
                    </button>
                </div>
