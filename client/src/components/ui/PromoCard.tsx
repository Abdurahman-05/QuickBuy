...
function PromoCard({ promo }: PromoCardProps) {
    return (
        <Link to="/products" className="group cursor-pointer bg-white rounded-3xl p-6 sm:p-8 flex flex-col-reverse sm:flex-row items-center justify-between w-full shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full sm:w-[55%] mt-6 sm:mt-0 flex flex-col text-center sm:text-left">
                ...
                <div className="mt-auto">
                    <span className="inline-flex items-center text-sm font-bold text-indigo-600 group-hover:text-indigo-800 transition-colors group/btn">
                        Explore Collection
